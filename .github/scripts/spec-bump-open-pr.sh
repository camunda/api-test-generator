...
Auto-generated by the spec-bump check (#387): latest camunda/camunda@main
...
body_file="$(mktemp)"
{
  echo "Auto-generated by the spec-bump check (#387). Latest \`camunda/camunda@main\` (\`${LATEST}\`) flows through the ${CONFIG} generate pipeline **and** regression invariants cleanly, so the pin is safe to adopt."
  echo
