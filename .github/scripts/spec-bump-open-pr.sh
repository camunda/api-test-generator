...
Auto-generated by the spec-bump check (#387): latest ${UPSTREAM_REPO}@${UPSTREAM_BRANCH}
...
body_file="$(mktemp)"
{
  echo "Auto-generated by the spec-bump check (#387). Latest \`${UPSTREAM_REPO}@${UPSTREAM_BRANCH}\` (\`${LATEST}\`) flows through the ${CONFIG} generate pipeline **and** regression invariants cleanly, so the pin is safe to adopt."
  echo
